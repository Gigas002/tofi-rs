...
The theoritically-compatible to original `tofi` tag is `0.10.0`. If you are interested in supporting original use-case scenarios and overhaul the code - propose changes to `v0` branch, but better just fork it since it'll be on life support without much interest from me.
